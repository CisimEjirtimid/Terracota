...
{
    viewport_info::viewport_info(const vk::Extent2D& extent)
        : _viewport{ 0.f, 0.f, float(extent.width), float(extent.height), 0.f, 1.f }
        , _scissor{ { 0, 0 }, extent }
    {}

    vk::PipelineViewportStateCreateInfo& viewport_info::operator()() const
    {
        static auto info = vk::PipelineViewportStateCreateInfo{}
